...
const TaskModal: React.FC<TaskModalProps> = ({ task, onClose }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      const response = await axios.put(`https://taskbliss-backend.onrender.com/api/todo/update/${task._id}`, formData);
  ...
  const handleDelete = async () => {
    try {
      const response = await axios.delete(`https://taskbliss-backend.onrender.com/api/todo/delete/${task._id}`);
