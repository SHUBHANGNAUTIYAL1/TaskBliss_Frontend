...
function Carousel() {
  ...
  return (
    <div className="w-full rounded-md  bg-[#FEFAEA] flex  justify-center items-center  py-10 md:py-20">
    <div className="w-full   flex flex-col justify-center items-center gap-6 md:gap-16">
       <div className='bg-black flex items-center gap-4 pl-2 pr-8 rounded-full py-2'>
         <div className='flex p-2 justify-center items-center rounded-full bg-[#C4F72C] spin'>
            <img src={star} alt="" />
         </div>
