...
const LoginForm: React.FC = () => {
  ...
  const handleSubmit = async(e: React.FormEvent) => {
    e.preventDefault();
    try {
        const res = await axios.post("https://taskbliss-backend.onrender.com/api/auth/login", loginData);
  ...
  return (
    <div className="w-full h-[100vh] flex items-center justify-center bg-cyan-200">
      <div className="w-[50%] h-[60%] flex items-center justify-center">   
         <img src={log} alt="" className='w-[100%] h-[100%] animate-mask-left' /> 
      </div>
      <div className='w-[50%] flex h-full items-center justify-center'> 
      <div className= "  bg-white p-8 rounded-lg  shadow-black shadow-lg w-full max-w-md right-8 transition-all duration-1000 animate-mask">
